      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
          <div class="table-responsive">
            <form method='POST' action="{{route('Card.update',['id'=>$card->id])}}" role="form">
              {{method_field('PUT') }}
              {{csrf_field()}}
               <table align='center' cellspacing=2 cellpadding=5 class="table table-bordered" id="dataTable" width="100%" cellspacing="0" border=1>
                <thead>
                  ...
                  <tr id="row1">            
                    ...
                    <td><input type="text" id="Qr_number" name="Qr_number" value="{{$card->Qr_number}}"></td>
                    <td><input type="text" id="Rfid_number" name="Rfid_number" value="{{$card->Rfid_number}}"></td>
                    ...
                    -->
                    <input type="submit" value="save" class="btn btn-success fa" style="display: inline !important; padding: 2px  !important; width: 50% !important;" class="save btn-success fa">
                    <hr>
                    <a name="cancel" id="cancel" href="{{route('Card.update',['id'=>$card->id])}}" class="btn btn-success fa"  style="display: inline !important; padding: 2px  !important; width: 50% !important;" class="cancel btn-success fa">cancel</a>
