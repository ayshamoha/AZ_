      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
          <div class="table-responsive">
            <form method='POST' action="{{route('Owner.update',['id'=>$owner->id])}}" role="form">
              {{method_field('PUT') }}
              {{csrf_field()}}
               <table align='center' cellspacing=2 cellpadding=5 class="table table-bordered" id="dataTable" width="100%" cellspacing="0" border=1>
                <thead>
                  ...
                  <tr id="row1">            
                    ...
                    <td><input type="email" id="email" name="email" value="{{$owner->email}}"></td>
                    <td><input type="text" id="name" name="name" value="{{$owner->name}}"></td>
                    <td><input type="number" id="phone_number" name="phone_number" value="{{$owner->phone_number}}"></td>
                    <td id="points">{{$owner->points}}</td>
                    <td><input type="file" id="images" name="images" value="{{$owner->images}}"></td>
                    ...
                    <hr>
                    <a name="cancel" id="cancel" href="{{route('Owner.update',['id'=>$owner->id])}}" class="btn btn-success fa"  style="display: inline !important; padding: 1px  !important; width: 50% !important;" class="cancel btn-success fa">cancel</a>
                ...
                <tfoot>
                  ...
                  <div class="container-fluid">
                    ...
                    <td><a name="A" id="A" href="{{route('Owner.create')}}" class="btn btn-warning fa" class="add">Add New Owner</a></td>
