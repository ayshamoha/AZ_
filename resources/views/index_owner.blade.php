    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Data Table Of Owner</div>
        <div class="card-body">
             ...
             <table align='center' cellspacing=2 cellpadding=5 class="table table-bordered" id="dataTable" width="100%" cellspacing="0" border=1>
              ...
              @foreach($owners as $owner)              
                <tr id="row1">            
                  ...
                  -->
                  <a name="edit" id="edit" href="{{route('Owner.edit',['id'=>$owner->id])}}" class="btn btn-success fa" class="edit btn-success fa">Edit</a>
