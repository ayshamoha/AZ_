             ...
             <table align='center' cellspacing=2 cellpadding=5 class="table table-bordered" id="dataTable" width="100%" cellspacing="0" border=1>
              <thead>
                ...
                <tr id="row1">
                  ...
                  -->
                  <a name="edit" id="edit" href="{{route('Card.edit',['id'=>$card->id])}}" class="btn btn-success fa" style="display: initial !important;" class="edit btn-success fa">Edit</a>
              ...
              <tfoot>
                <div class="container-fluid">
                  ...
                  <td><a name="A" id="A" href="{{route('Card.create')}}" class="btn btn-warning fa" class="add">Add more cards</a></td>
